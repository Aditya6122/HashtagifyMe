...
def load_model(device,from_local=True):
    ...
    if from_local:
        ...
        if not os.path.isfile(local_path):
            ...
            try:
                remote_model_path = 'https://drive.google.com/file/d/1vxmwsSSUQ0MTjfQ2uSAc9J96ezuoh9aa/view?usp=sharing'
                gdown.download(url=remote_model_path ,output=local_path,quiet=False,fuzzy=True,speed=1000*1024)
            except:
